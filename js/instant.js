...
function m(o) {
    if (o && o.href && (!n || "instant" in o.dataset)) {
        ...
        if (["http:", "https:"].includes(o.protocol) &&
            ...
            !(o.hash && o.pathname + o.search == location.pathname + location.search || "noInstant" in o.dataset)) return !0;
    }
}
...
!function() {
    ...
    if ("instantIntensity" in document.body.dataset) {
        ...
        if (t.startsWith("mousedown")) f = !0, "mousedown-only" == t && (v = !0);
            ...
            e || n || ("viewport" == t ?
                document.documentElement.clientWidth * document.documentElement.clientHeight < 45e4 && (g = !0) :
                "viewport-all" == t && (g = !0));
        } else {
            const e = parseInt(t);
            isNaN(e) || (s = e);
